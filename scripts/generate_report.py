...
body{{font-family:"Avenir Next","Segoe UI",system-ui,sans-serif;line-height:1.7;color:var(--color);background:var(--background);padding:1.5rem;max-width:900px;margin:0 auto}}
...
.finding{{font-size:.85rem;padding:.8rem;background:var(--bg-secondary);border:1px solid var(--border);border-radius:.4rem;margin:.8rem 0}}
